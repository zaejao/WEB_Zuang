    ...
    $('.colors li').on('click', function() {
      ...
      if (!self.hasClass('active')) {
        ...
        if (skin.hasClass('skin-square')) {
          ...
          /* /////////////   Edited by Zuang  ///////////  */
          /*
          if (skin.hasClass('skin-square-red')) {
            checkbox_default = 'icheckbox_square';
            radio_default = 'iradio_square';
            checkbox === undefined && (checkbox = 'icheckbox_square-red', radio = 'iradio_square-red');
          }
          ...
          if (skin.hasClass('skin-square-green')) {
            checkbox_default = 'icheckbox_square';
            radio_default = 'iradio_square';
          ...
          if (skin.hasClass('skin-square-blue')) {
            checkbox_default = 'icheckbox_square';
            radio_default = 'iradio_square';
            checkbox === undefined && (checkbox = 'icheckbox_square-blue', radio = 'iradio_square-blue');
          }


          if (skin.hasClass('skin-square-orange')) {
            checkbox_default = 'icheckbox_square';
            radio_default = 'iradio_square';
            checkbox === undefined && (checkbox = 'icheckbox_square-orange', radio = 'iradio_square-orange');
          }
            
            
          if (skin.hasClass('skin-square-yellow')) {
            checkbox_default = 'icheckbox_square';
            radio_default = 'iradio_square';
            checkbox === undefined && (checkbox = 'icheckbox_square-yellow', radio = 'iradio_square-yellow');
          }
            */
            /* /////////////   End Edited by Zuang  ///////////  */
...
/*
    ...
    $('.skin-square-red input').iCheck({
        checkboxClass: 'icheckbox_square-red',
        radioClass: 'iradio_square-red',
    });
    $('.skin-square-green input').iCheck({
      checkboxClass: 'icheckbox_square-green',
        radioClass: 'iradio_square-green',
    });
    $('.skin-square-blue input').iCheck({
      checkboxClass: 'icheckbox_square-blue',
      radioClass: 'iradio_square-blue',
    });*/
    $('.skin-square-orange input').iCheck({
      checkboxClass: 'icheckbox_square-orange',
        radioClass: 'iradio_square-orange',
    });
    /*
    $('.skin-square-yellow input').iCheck({
