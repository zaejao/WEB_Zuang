    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          ...
          <h3 class="content-header-title">ศาสนา</h3>
        </div>
      </div>
              ...
              <div class="card">
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    ...
                    <table id="sciencesTable" class="table table-striped table-borderless table-hover bootstrap-3 " style="width:100%">
                      <thead>
                        <tr align="center" style="background-color:#0f1733; color:whitesmoke;" >
                         <th></th>
                          <th>ลำดับที่</th>
                          <th>ChiefSpcCode</th>
                          <th>PersonTypeCode</th>
                          <th>ChiefSpcName</th>
                          <th>ChiefSpcAbbrName</th>
                          <th>สถานะ</th>
                        </tr>
                      </thead>
                      <tbody align="center">
  ...
  <script src="../../Controllers/sciencesController.js"></script>
