      ...
      <div class="content-wrapper">
          <div class="content-header row">
              <div class="content-header-left col-md-6 col-12 mb-2">
                  <h3 class="content-header-title">เพิ่มประเภทที่ขอบรรจุ</h3>
          ...
          <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">เพิ่มประเภทที่ขอบรรจุ</li>
              </ol>
          </nav>
                                  ...
                                  <div class="card-body">
                                      ...
                                      <form class="form form-horizontal">
                                          <div class="form-body">
                                              <div class="row">
                                                  <div class="col-md-6">
                                                      <label class="col-md-12 label-control" for="userinput1">ชื่อเต็มประเภทที่ขอบรรจุ</label>
                                                      <div class="col-md-12">
                                                          <div class="position-relative ">
                                                              <input type="text" id="userinput1" class="form-control border-primary" placeholder="ชื่อเต็มประเภทที่ขอบรรจุ" name="fullName">

                                                          </div>
                                                      </div>
                                                  </div>
                                                  <div class="col-md-6">
                                                      <label class="col-md-12 label-control" for="userinput2">ชื่อย่อประเภทที่ขอบรรจุ</label>
                                                      <div class="col-md-12">
                                                          <div class="position-relative">
                                                              <input type="text" id="userinput2" class="form-control border-primary" placeholder="ชื่อย่อประเภทที่ขอบรรจุ" name="initName">
                                                          </div>
                                                      </div>
                                                  </div>
                                              </div>
