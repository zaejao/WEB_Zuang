    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          ...
          <h3 class="content-header-title">ยศ</h3>
        </div>
      </div>
                  ...
                  <div class="card-body card-dashboard">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">ยศ</li>
                      </ol>
                    </nav>
                    ...
                    <table id="rankData" class="table table-striped table-borderless table-hover bootstrap-3 " style="width:100%;">
                      <thead>
