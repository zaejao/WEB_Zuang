    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          ...
          <h3 class="content-header-title">หลักสูตรที่ใช้ในการบรรจุเข้ารับราชการ</h3>
        </div>
      </div>
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="../home/index.php">ระบบงานโอนย้าย</a></li>
                        <li class="breadcrumb-item active" aria-current="page">หลักสูตรที่ใช้ในการบรรจุเข้ารับราชการ</li>
                      </ol>
                    </nav>
