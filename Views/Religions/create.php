      ...
      <div class="content-wrapper">
          <div class="content-header row">
              <div class="content-header-left col-md-6 col-12 mb-2">
                  <h3 class="content-header-title">เพิ่มศาสนา</h3>
          ...
          <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">เพิ่มศาสนา</li>
              </ol>
          </nav>
                                      ...
                                      <form class="form form-horizontal">
                                          <div class="form-body">
                                              ...
                                              <div class="form-actions center" align="center">
                                                  ...
                                                  <button type="button" class="btn btn-success  round btn-min-width mr-1 mb-1" id="submit" onclick="insertReligions()">บันทึก</button>
                                              </div>
                                          </div>
                                      </form>
                                  </div>
