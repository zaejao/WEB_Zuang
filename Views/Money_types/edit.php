      ...
      <div class="content-wrapper">
          <div class="content-header row">
              <div class="content-header-left col-md-6 col-12 mb-2">
                  <h3 class="content-header-title">แก้ไขเงินเพิ่ม</h3>
          ...
          <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">แก้ไขเงินเพิ่ม</li>
              </ol>
          </nav>
                                  ...
                                  <div class="card-body">
                                      ...
                                      <form class="form form-horizontal">
                                          <div class="form-body">
                                              <div class="row">
                                                  <div class="col-md-6">
                                                      <label class="col-md-6 label-control" for="userinput1">ชื่อเต็มเงินเพิ่ม</label>
                                                      <div class="col-md-12">
                                                          <div class="position-relative ">
                                                              <input type="text" id="userinput1" class="form-control border-primary" placeholder="ชื่อเต็มเงินเพิ่ม" name="fullName">

                                                          </div>
                                                      </div>
                                                  </div>
                                                  <div class="col-md-6">
                                                      <label class="col-md-6 label-control" for="userinput2">ชื่อย่อเงินเพิ่ม</label>
                                                      <div class="col-md-12">
                                                          <div class="position-relative">
                                                              <input type="text" id="userinput2" class="form-control border-primary" placeholder="ชื่อย่อเงินเพิ่ม" name="initName">
                                                          </div>
                                                      </div>
                                                  </div>
                                              </div>
