                                  ...
                                  <div class="card-body">
                                      ...
                                      <form class="form form-horizontal">
                                          <div class="form-body">
                                              <div class="row">
                                                  <div class="col-md-6">
                                                      <label class="col-md-12 label-control" for="degreeName">ชื่อเต็มระดับการศึกษา</label>
                                                      <div class="col-md-12">
                                                  ...
                                                  <div class="col-md-6">
                                                      <label class="col-md-12 label-control" for="degreeAbrrName">ชื่อย่อระดับการศึกษา</label>
                                                      <div class="col-md-12">
                                                          <div class="position-relative">
                                              ...
                                              <div class="form-actions center" align="center">
                                                  ...
                                                  <button type="button" class="btn btn-success  round btn-min-width mr-1 mb-1" id="submit" onclick="insertDegrees()">บันทึก</button>
                                              </div>
                                          </div>
                                      </form>
                                  </div>
