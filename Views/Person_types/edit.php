                                  ...
                                  <div class="card-body">
                                      ...
                                      <form class="form form-horizontal">
                                          <div class="form-body">
                                              <div class="row">
                                                  <div class="col-md-6">
                                                      <label class="col-md-12 label-control" for="personTypeName">ชื่อประเภทกำลังพล</label>
                                                      <div class="col-md-12">
                                                          <div class="position-relative ">
                                                              <input type="text" id="personTypeName" class="form-control border-primary" placeholder="ชื่อประเภทกำลังพล" name="personTypeName">
                                              ...
                                              <div class="row">
                                                  <div class="col-md-12">
                                                      ...
                                                      <input type="hidden" id="personTypesId" name="personTypesId">
                                                  </div>
                                              </div>
                                              <div class="form-actions center" align="center">
                                                  <button type="button" class="btn btn-danger  round btn-min-width mr-1 mb-1" id="type-error">ยกเลิก</button>
                                                  <button type="button" class="btn btn-success  round btn-min-width mr-1 mb-1" id="submit" onclick="UpdatePersonTypes()">บันทึก</button>
                                              </div>
                                          </div>
                                      </form>
                                  </div>
